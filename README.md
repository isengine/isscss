...
- [Основные параметры](#основные-параметры)
  ...
  - [Размерный ряд](#размерный-ряд)
    ...
    - [Специальные величины](#специальные-величины)
    - [Кастомизация](#кастомизация)
  - [Компоненты](#компоненты)
  - [Префикс](#префикс)
- [Классы](#классы)
  - [Общие правила](#общие-правила)
  - [Короткое написание](#короткое-написание)
  - [Модификаторы направлений](#модификаторы-направлений)
  - [Установки по-умолчанию](#установки-по-умолчанию)
  - [Классы отступов](#классы-отступов)
  - [Классы краев](#классы-краев)
    - [Толщина края](#толщина-края)
    - [Радиус края](#радиус-края)
    - [Цвет края](#цвет-края)
  - [Классы ширины и высоты](#классы-ширины-и-высоты)
  - [Классы отображения](#классы-отображения)
  - [Специальны классы отображения](#специальны-классы-отображения)
  - [Классы позиционирования](#классы-позиционирования)
  - [Класс позиционирования по оси z](#класс-позиционирования-по-оси-z)
  - [Классы выравнивания](#классы-выравнивания)
  - [Классы изображений](#классы-изображений)
    - [Загрузка фоновых изображений](#загрузка-фоновых-изображений)
    - [Фон в виде градиента](#фон-в-виде-градиента)
    - [Выравнивание изображений](#выравнивание-изображений)
    - [Выравнивание фоновых изображений](#выравнивание-фоновых-изображений)
    - [Выравнивание масок](#выравнивание-масок)
  - [Классы цветовой палитры](#классы-цветовой-палитры)
  - [Классы прозрачности](#классы-прозрачности)
  - [Классы текста](#классы-текста)
    - [Шрифт](#шрифт)
    - [Свойства шрифта](#свойства-шрифта)
    - [Свойства текста](#свойства-текста)
  - [Тени](#тени)
  - [Контейнер flex box](#контейнер-flex-box)
    - [Расположение элементов](#расположение-элементов)
    - [Размеры](#размеры)
    - [Порядок](#порядок)
    - [Выравнивание](#выравнивание)
  - [Контейнер grid](#контейнер-grid)
  - [Анимации](#анимации)
- [Пользовательский интерфейс](#пользовательский-интерфейс)
- [Создание собственных классов](#создание-собственных-классов)
...
За использование библиотеки как **utility first** отвечают [**Компоненты**](#компоненты).
...
Подробнее смотрите в разделе [**Создание собственных классов**](#создание-собственных-классов).
...
Вы также можете наследовать имена классов. Подробнее смотрите в разделе [**Создание собственных классов**](#создание-собственных-классов).
...
Подробно об этом описано в разделе [**Классы цветовой палитры**](#классы-цветовой-палитры).
...
Если же вы хотите включить в файл стилей некоторые из встроенных классов библиотеки, тогда настройте эти классы через [**Компоненты**](#компоненты).
